...
public class VtnCosultaCl extends javax.swing.JFrame {
    ...
    public void llena() {
        ...
        List<Cliente> listC = ferrD.listaCliente();
        for (Cliente c : listC) {
            desp += c.toString()
                    + "\n--------------------------------\n";
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VtnCosultaCl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VtnCosultaCl().setVisible(true);
            }
        });
    }
