 ...
 * @author Equipo1
 */
public class VtnConsulPItem extends javax.swing.JFrame
{

    /**
     * Creates new form VtnProductosB
     */
    public VtnConsulPItem()
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnNomB.setText("Clave de producto");
        ...
        btnClvB.setText("Todos los productos");
        ...
        txtBajasTitulo.setText("Consulta de productos");
        panelConsultas.add(txtBajasTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 40));
    ...
    {//GEN-HEADEREND:event_btnClvBActionPerformed
        VtnCosultaP vtnConsulP = new VtnCosultaP();
        vtnConsulP.setVisible(true);
    ...
    {//GEN-HEADEREND:event_btnNomBActionPerformed
        VtnCosultaCveP vtnConsulCveP = new VtnCosultaCveP();
        vtnConsulCveP.setVisible(true);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnConsulPItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VtnConsulPItem().setVisible(true);
            }
        });
    }
